...
export default function Header({
  ...
  return (
    <header
      className={cn(
        "fixed top-0 w-full h-14 bg-white grid items-center grid-cols-[48px_1fr_48px] justify-between border-b border-gray-100",
    ...
    >
      ...
      {isFunc && (
        <button
          type="button"
          className="w-12 h-14 flex justify-center items-center font-bold text-sm"
          onClick={onFuncClick}
        >
          {isFunc}
        </button>
